...
public class SenoThread extends Thread {
    private final int nroThread;
    private final int start;
    private final int end;
    private double[] localVector;
    
    public SenoThread(int nroThread, int start, int end){
    ...
    public void run(){
        ...
        try { localVector = Client.servicoRMI.seno(localVector); } //Passar vetor para método RMI logaritmo
